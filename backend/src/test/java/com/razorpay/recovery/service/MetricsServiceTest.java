...
class MetricsServiceTest {
    ...
    @BeforeEach
    void setUp() {
        metricsService = new MetricsService(transactionRepository, attemptRepository);
    }
    ...
    void baselineSimulation_matchesHandComputedExpectedValue() {
        ...
        MetricsService.BaselineResult result = metricsService.simulateBaseline(txs);
    ...
    void baselineSimulation_withEmptyList_returnsZero() {
        MetricsService.BaselineResult result = metricsService.simulateBaseline(List.of());
